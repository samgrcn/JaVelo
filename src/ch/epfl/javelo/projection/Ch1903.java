...
public final class Ch1903 {
    ...
    public static double e(double lon, double lat) {
        ...
        return 2600072.37 + 211455.93 * delta1 - 10938.51 * delta1 * phi1
                - 0.36 * delta1 * Math.pow(phi1, 2) - 44.54 * Math.pow(delta1, 3);
    }
    ...
    public static double n(double lon, double lat) {
        ...
        return 1200147.07 + 308807.95 * phi1
                + 3745.25 * Math.pow(delta1, 2) + 76.63 * Math.pow(phi1, 2)
                - 194.56 * Math.pow(delta1, 2) * phi1 + 119.79 * Math.pow(phi1, 3);
    }
    ...
    public static double lon(double e, double n) {
        ...
        double delta0 = 2.6779094 + 4.728982 * x + 0.791484 * x * y
    ...
    public static double lat(double e, double n) {
        ...
        double phi0 = 16.9023892 + 3.238272 * y - 0.270978 * Math.pow(x, 2)
                - 0.002528 * Math.pow(y, 2) - 0.0447 * Math.pow(x, 2) * y
                - 0.0140 * Math.pow(y, 3);
