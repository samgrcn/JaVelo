...
public record GraphSectors(ByteBuffer buffer) {
    ...
    private static final int OFFSET_TO_NODE_NUMBER = Integer.BYTES; //number of bytes in an integer
    private static final int OFFSET_TO_NEXT_SECTOR = OFFSET_TO_NODE_NUMBER + Short.BYTES; //number of bytes per sector
